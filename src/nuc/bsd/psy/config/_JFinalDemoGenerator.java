...
import nuc.bsd.psy.tools.DebugInfo;
...
public class _JFinalDemoGenerator {
	...
	public static void main(String[] args) {
		// base model 所使用的包名
		String baseModelPackageName = "nuc.bsd.psy.base.model";
		// base model 文件保存路径
		String baseModelOutputDir = PathKit.getWebRootPath()
				+ "/../src/nuc/bsd/psy/base/model";

		// model 所使用的包名 (MappingKit 默认使用的包名)
		String modelPackageName = "nuc.bsd.psy.domain";
		// model 文件保存路径 (MappingKit 与 DataDictionary 文件默认保存路径)
		String modelOutputDir = PathKit.getWebRootPath()
				+ "/../src//nuc/bsd/psy/domain/";
		...
		// "User"而非 OscUser
		gernerator.setRemovedTableNamePrefixes("psy_");
		// 生成
		gernerator.generate();
		// 打印完成
