...
public class PartFourQuestionService {
	...
	public List<Que> getPartFourQuestions(User user) {
				...
				if("1".equals(user.getOption_n())){
					sb.append("select DISTINCT b.id as recId,b.content as stem,b.question_code as code,b.option_number as optionNumber ,part from test_table a left join question_bank b on a.question_code = b.question_code where a.EC_code = ? and a.option_number = 5 and part = 40 and op_type_F = 1");	
				}else{
